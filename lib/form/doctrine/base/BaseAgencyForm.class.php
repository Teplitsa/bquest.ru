  ...
  public function setup()
  {
    parent::setup();
		...
		if($this->needsWidget('description')){
			...
			$this->setValidator('description', new sfValidatorString(array('max_length' => 2048, 'required' => false)));
		}
		//column
		if($this->needsWidget('coordinator_name')){
			$this->setWidget('coordinator_name', new sfWidgetFormInputText());
			$this->setValidator('coordinator_name', new sfValidatorString(array('max_length' => 255, 'required' => false)));
		}
		//column
		if($this->needsWidget('coordinator_telephone')){
			$this->setWidget('coordinator_telephone', new sfWidgetFormInputText());
			$this->setValidator('coordinator_telephone', new sfValidatorString(array('max_length' => 255, 'required' => false)));
		}
		//column
		if($this->needsWidget('website')){
			$this->setWidget('website', new sfWidgetFormInputText());
			$this->setValidator('website', new sfValidatorString(array('max_length' => 255, 'required' => false)));
		}
		//column
