...
abstract class BaseDmUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    parent::setup();
		...
		//column
		if($this->needsWidget('user_type')){
			$this->setWidget('user_type', new sfWidgetFormInputText());
			$this->setValidator('user_type', new sfValidatorInteger(array('required' => false)));
		}
		//column
