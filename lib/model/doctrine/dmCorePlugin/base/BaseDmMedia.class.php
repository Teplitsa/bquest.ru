 ...
 * @method DmMedia       setQuest()              Sets the current record's "Quest" value
 * @method DmMedia       setAgency()             Sets the current record's "Agency" value
 * @method DmMedia       setTeam()               Sets the current record's "Team" value
 * 
 * @package    bquest
 * @subpackage model
