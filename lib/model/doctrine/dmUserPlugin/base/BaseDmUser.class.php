 ...
 * @method DmUser              setUserType()                       Sets the current record's "user_type" value
 ...
 * @method DmUser              setAgency()                         Sets the current record's "Agency" value
 * @method DmUser              setTeam()                           Sets the current record's "Team" value
 * 
 * @package    bquest
 * @subpackage model
...
abstract class BaseDmUser extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('user_type', 'integer', null, array(
             'type' => 'integer',
             ));
